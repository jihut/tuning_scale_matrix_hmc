...
source("tuning_procedures_main_scripts/ISG/first_step_ISG_general_function_of_grhmc_adaptive.R")
...
final_ISG_general_function_of_grhmc_adaptive <- function(
    log_target_grad,
    lambda_initial,
    n_parameters = NULL,
  ...
  first_step_run <- first_step_grhmc_transformed_function_ISG(
